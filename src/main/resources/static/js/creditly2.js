var Creditly2 = (function() {
  ...
  var createSelectorValidatorMap = function(expirationSelector, creditCardNumberSelector, cvvSelector, options) {
    ...
    optionValues["security_code_message"] = optionValues["security_code_message"] || "Tu código de seguridad no es válido";
    optionValues["number_message"] = optionValues["number_message"] || "Su número de tarjeta de crédito no es válido.";
    optionValues["expiration_message"] = optionValues["expiration_message"] || "El vencimiento de su tarjeta de crédito no es válido";
