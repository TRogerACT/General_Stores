		...
		<div class="container py-xl-4 py-lg-2">
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-12">
					<div class="wrapper">
						...
						<div class="px-sm-4 px-3 py-sm-5 py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Resultado De búsqueda</h3>
							<div class="row">
						<c:choose>
				...
				<div class="col-lg-12 col-sm-12 col-md-12 alert alert-info alert-dismissible fade show text-center">
					No product found.
					&nbsp;<a href="${pageContext.request.contextPath}/home" class="btn btn-success text-right">Vete a Inicio</a>
