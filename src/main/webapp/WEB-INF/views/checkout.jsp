...
<c:if test="${empty email}">
	...
	<title>Rodrigos de Carnicos | Verificar</title>
							...
							<div class="information-wrapper">
								<div class="first-row">
									...
									<div class="w3_agileits_card_number_grids">
										...
										<div class="w3_agileits_card_number_grid_right form-group">
											<div class="controls">
											<label class="col-form-label"><b>Código PIN</b> [A partir de ahora está disponible la entrega del producto para el código pin 400601.]</label>
