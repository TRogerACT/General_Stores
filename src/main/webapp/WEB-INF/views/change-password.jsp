...
<!-- log in -->
	...
	<c:if test="${not empty success}">
        ...
        <strong>Change Password!</strong> Contraseña cambiada correctamente.
        Click  <a href="${pageContext.request.contextPath}/customer/login" style="text-decoration: underline;" class="title">Aquí</a> iniciar sesión.<button type="button" class="close" data-dismiss="alert">&times;</button>
   				</div>
			</c:if>
				...
				<div class="col-md-12">
					<form action="${pageContext.request.contextPath}/customer/changePassword" method="post">
						...
						<div class="form-group">
							...
							<input type="password" placeholder="Contraseña" size="35" maxlength="64" minlength="6" class="form-control" name="password" required="required" />
						</div>	
						<div class="form-group">
							<label class="col-form-label">Confirmar Contraseña</label>
							<input type="password" placeholder="Confirmar Contraseña" size="35" maxlength="64" minlength="6" class="form-control" name="confirm-password" id="password" required="required" />					
						</div>
						<div class="right-w3l">
							<input type="submit" class="form-control" value="Restablecer la contraseña">
						</div>
					</form>
					</div>
				</div>
