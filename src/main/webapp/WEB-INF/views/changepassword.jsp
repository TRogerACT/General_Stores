				...
				<div class="col-md-12">
					<form action="${pageContext.request.contextPath}/customer/changeCustomerPassword" method="post">
						...
						<div class="form-group">
							...
							<input type="password" size="35" placeholder="Confirmar Contraseña" maxlength="64" minlength="6" class="form-control" name="confirm-password" id="password" required="required" />					
						</div>
						<div class="right-w3l">
