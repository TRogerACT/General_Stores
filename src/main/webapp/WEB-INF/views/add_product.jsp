...
<html>
<head>
	<title>Rodrigos de Carnicos | Añadir Productos</title>
				...
				<div class="contact-grids1 w3agile-6">
					<div class="row">
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							...
							<input type="text" class="form-control" placeholder="Nombre del Producto" id="name" name="name" required="required">
							<p id="error_name"></p>
						</div>
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							<label class="col-form-label">Descripción</label>
							<textarea class="form-control" placeholder="Descripción del producto" id="description" rows="3" cols="45" name="description" required="required"></textarea>
						...
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							...
							<input type="text" class="form-control" placeholder="Precio" name="mrp_price" id="mrp_price" required="required">
							<p id="error_mrp_price"></p>
						</div>
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							<label class="col-form-label">Oferta</label>
							<input type="text" class="form-control" placeholder="Oferta" name="price" id="price" required="required">
							<p id="error_price"></p>
						</div>
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
